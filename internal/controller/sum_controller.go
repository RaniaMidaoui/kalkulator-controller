...
import (
	...
	kalkulatorv1 "github.com/RaniaMidaoui/kalkulator/api/v1"
)
...
//+kubebuilder:rbac:groups=kalkulator.kalkulator.io,resources=sums,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=kalkulator.kalkulator.io,resources=sums/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=kalkulator.kalkulator.io,resources=sums/finalizers,verbs=update
